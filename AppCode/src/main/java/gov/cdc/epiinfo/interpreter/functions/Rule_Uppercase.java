...
public class Rule_Uppercase extends EnterRule 
{
    private List<EnterRule> ParameterList = new ArrayList<EnterRule>();

    public Rule_Uppercase(Rule_Context pContext, Reduction pToken)
    ...
    public Object Execute()
    {
        try
        {
        	...
        	return this.ParameterList.get(0).Execute().toString().toUpperCase();
        }
        catch(Exception ex)
        {
            return null;
